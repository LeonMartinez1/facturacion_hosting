...
$traslado = $_POST["traslado"] ? $_POST["traslado"] : $_GET["traslado"];
...
$rem_estado=$res_traslado['rem_estado'];
$rem_localida=$res_traslado['rem_localidad'];
$rem_municipio=$res_traslado['rem_municipio'];
$rem_codigo_postal=$res_traslado['rem_codigo_postal'];
$rem_colonia=$res_traslado['rem_colonia'];


$dest_estado=$res_traslado['dest_estado'];
$dest_localida=$res_traslado['dest_localidad'];
$dest_municipio=$res_traslado['dest_municipio'];
$dest_codigo_postal=$res_traslado['dest_codigo_postal'];
$dest_colonia=$res_traslado['dest_colonia'];

/* Catalogos */

$d_localidad= $returned['data']['localidad'];
//$driver_localidad= array();

$query="select id,c_localidad,description from sat_ce_localidad";
$res=mysqli_query($conn,$query);
if($res){
	while($row=mysqli_fetch_assoc($res)){
		$driver_localidad[$row["description"]]=$row["id"];
	}
	
}
//die(json_encode($driver_localidad));

$d_municipio= $returned['data']['municipio'];
//$driver_municipio= array();

$query="select id,c_municipio,description from sat_ce_municipio";
$res=mysqli_query($conn,$query);
if($res){
	while($row=mysqli_fetch_assoc($res)){
		$driver_municipio[$row["description"]]=$row["id"];
	}
	
}

$rem_colonias= array();
$query = "SELECT * from sat_ce_colonia1 where c_codigo_postal = '".$rem_codigo_postal."' and c_colonia = '".$rem_colonia."' UNION SELECT * from sat_ce_colonia2 where c_codigo_postal = '".$rem_codigo_postal."' and c_colonia = '".$rem_colonia."' UNION SELECT * from sat_ce_colonia3 where c_codigo_postal = '".$rem_codigo_postal."' and c_colonia = '".$rem_colonia."' LIMIT 1";

//die(json_encode($query));
$res=mysqli_query($conn,$query);
if($res){
	$row=mysqli_fetch_assoc($res);
		$rem_colonias[$row["description"]]=$row["c_colonia"];

	
}

//$rem_codigo_p= array();
$query = "SELECT * from sat_ce_codigo_p_cfdi where c_codigo_postal = $rem_codigo_postal LIMIT 1";

//die(json_encode($query));
$res=mysqli_query($conn,$query);
if($res){
	$row=mysqli_fetch_assoc($res);
		$rem_codigo_p[$row["c_codigo_postal"]]=$row["c_codigo_postal"];
	
	
}

//$dest_codigo_p= array();
$query = "SELECT * from sat_ce_codigo_p_cfdi where c_codigo_postal = $dest_codigo_postal LIMIT 1";

$res=mysqli_query($conn,$query);
if($res){
	$row=mysqli_fetch_assoc($res);
		$dest_codigo_p[$row["c_codigo_postal"]]=$row["c_codigo_postal"];
	
	
}

//$dest_colonias= array();
$query = "SELECT * from sat_ce_colonia1 where c_codigo_postal = '".$dest_codigo_postal."' and c_colonia = '".$dest_colonia."' UNION SELECT * from sat_ce_colonia2 where c_codigo_postal = '".$dest_codigo_postal."' and c_colonia = '".$dest_colonia."' UNION SELECT * from sat_ce_colonia3 where c_codigo_postal = '".$dest_codigo_postal."' and c_colonia = '".$dest_colonia."' LIMIT 1";

//die(json_encode($query));
$res=mysqli_query($conn,$query);
if($res){
	$row=mysqli_fetch_assoc($res);
		$dest_colonias[$row["description"]]=$row["c_colonia"];
                      ...
                      <form id="form_traslado" role="form" calss="text-start" style="font-size:.9rem;">
                          <div class="row">
                              <div class="col-sm-6">
                                  <div class="form-row">
                                      ...
                                      <input type="text" class="form-control" id="cliente" placeholder="Cliente" value="<?php echo $res_traslado['cliente_id']; ?>" disabled>
                                      </div>
                                      <div class="form-group col-md-6">
                                      <label for="cliente_rfc">RFC</label>
                                      <input type="text" class="form-control" id="cliente_rfc" placeholder="RFC" value="<?php echo $res_traslado['rfc_receptor']; ?>" disabled>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label for="cliente_nombre">Nombre</label>
                                      <input type="text" class="form-control" id="cliente_nombre" placeholder="Jhon Doe" value="<?php echo $res_traslado['nombre_receptor']; ?>" disabled>
                                  </div>
                                  <div class="form-group">
                                      <label for="cliente_email">Email</label>
                                      <input type="email" class="form-control" id="cliente_email" placeholder="Email" value="<?php echo $res_traslado['email']; ?>" disabled>
                                  </div>
                                  <div class="form-row">
                                      <div class="form-group col-md-6">
                                      <label for="observaciones">Observaciones</label>
                                      <textarea type="text" class="form-control" id="observaciones" <?php echo $res_traslado['observaciones']?"disabled":""; ?>><?php echo $res_traslado['observaciones']; ?></textarea>
                                      </div>
                                  </div>
                              ...
                              <div class="col-sm-6">
                                  <div class="form-row">
                                      ...
                                      <input type="text" class="form-control" id="serie_folio" placeholder="Serie" value="<?php echo $res_traslado['serie'].$res_traslado['folio']; ?>" disabled>
                                      </div>
                                      <div class="form-group col-md-4">
                                      <label for="referencia">Referencia</label>
                                      <input type="text" class="form-control" id="referencia" placeholder="Referencia" value="" disabled>
                                      </div>
                                      <div class="form-group col-md-4">
                                      <label for="fecha">Fecha</label>
                                      <input type="text" class="form-control" id="fecha" placeholder="Cliente" value="<?php echo $res_traslado['fecha']; ?>" disabled>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-row">
                                      ...
                                      <input class="form-control" type="text" id="metodo_pago" value="<?php echo $res_traslado['metodo_pago']; ?>" disabled>
                                        
                                      </div>
                                      <div class="form-group col-md-4">
                                      <label for="forma_pago">Forma de pago</label>
                                      <select id="forma_pago" class="form-control" disabled>
                                      ...
                                      <select id="cfdi_use" class="form-control" disabled>
                                        <option value="" selected>Seleccionar</option>
                                  ...
                                  <div class="form-row">
                                    <div class="form-group col-md-6">
                                          ...
                                          <select id="c_exportacion" class="form-control" disabled>
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-6">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                        <label for="codigo_rem">Codigo de Remitente</label>
                                        <input type="text" class="form-control" id="codigo_rem" placeholder="Cliente" value="<?php echo $res_traslado['rem'][0]['id']; ?>" disabled> 
                                        </div>
                                        <div class="form-group col-md-6">
                                        <label for="rfc_rem">RFC</label>
                                        <input type="text" class="form-control" id="rfc_rem" placeholder="RFC" value="<?php echo $res_traslado['rem'][0]['rfc']; ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="nombre_dest">Nombre</label>
                                        <input type="text" class="form-control" id="nombre_dest" placeholder="Jhon Doe" value="<?php echo $res_traslado['rem'][0]['cliente']; ?>" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="email_rem">Email</label>
                                        <input type="email" class="form-control" id="email_rem" placeholder="Email" value="<?php echo $res_traslado['rem'][0]['email']; ?>" disabled>
                                    </div>
                              ...
                              <div class="col-sm-6">
                                    <div class="form-row">
                                        ...
                                        <select id="codigo_postal2" class="form-control" disabled>
                                            <option value="<?php echo $res_traslado['rem_codigo_postal'];?>" selected><?php echo $r_driver['rem_codigo_postal'];?></option>
                                        </select>
                                        </div>
                                        <div class="form-group col-md-6">
                                        <label for="estado2">Estado</label>
                                        <select id="estado2" class="form-control" disabled>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <select id="municipio2" class="form-control" disabled>
                                            <option selected>Choose...</option>
                                            <option>...</option>
                                        </select>
                                        </div>
                                        ...
                                        <select id="localidad2" class="form-control" disabled>
                                            <option selected>Choose...</option>
                                            <option>...</option>
                                        </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="colonia2" class="form-control" disabled>
                                            <option selected>Choose...</option>
                                            <option>...</option>
                                        </select>
                                    </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-6">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                        <label for="codigo_dest">Codigo de Destinatario</label>
                                        <input type="text" class="form-control" id="codigo_dest" placeholder="Cliente" value="<?php echo $res_traslado['dest'][0]['id']; ?>" disabled>
                                        </div>
                                        <div class="form-group col-md-6">
                                        <label for="rfc_dest">RFC</label>
                                        <input type="text" class="form-control" id="rfc_dest" placeholder="RFC" value="<?php echo $res_traslado['dest'][0]['rfc']; ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="nombre_dest">Nombre</label>
                                        <input type="text" class="form-control" id="nombre_dest" placeholder="Jhon Doe" value="<?php echo $res_traslado['dest'][0]['cliente']; ?>" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="email_dest">Email</label>
                                        <input type="email" class="form-control" id="email_dest" placeholder="Email" value="<?php echo $res_traslado['dest'][0]['email']; ?>" disabled>
                                    </div>
                              ...
                              <div class="col-sm-6">
                                    <div class="form-row">
                                        ...
                                        <select id="codigo_postal" class="form-control" disabled>
                                            <option selected>Choose...</option>
                                            <option>...</option>
                                        </select>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <select id="localidad" class="form-control" disabled>
                                            <option selected>Choose...</option>
                                            <option>...</option>
                                        </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="colonia" class="form-control" disabled>
                                            <option selected>Choose...</option>
                                            <option>...</option>
                                        </select>
                                    </div>
                              ...
                              <div class="col-sm-12">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <label for="driver">Chofer</label>
                                            <input class="form-control" type="text" id="driver" value="<?php echo $res_traslado['driver'][0]['name']; ?>" disabled>
                                        
                                        </div>

                                        <div class="form-group col-md-4">
                                        <label for="appliance">Tipo unidad</label>
                                        <input class="form-control" type="text" id="appliance" value="<?php echo $res_traslado['appliance'][0]['name']; ?>" disabled>
                                        </div>

                                        <div class="form-group col-md-4">
                                        <label for="type_rem">Tipo remolque</label>
                                        <input class="form-control" type="text" id="type_rem" value="<?php echo $res_traslado['type_rem'][0]['n_economimc']; ?>" disabled>
                          ...
                          <!-- <div class="form-group">
                              <div class="form-check">
                                <input type="hidden" id="factura" name="factura" value="<?php echo $res_traslado['id']; ?>">
                  ...
                  <!-- <div class="row">
                      ...
                      <div class="card my-4">
                          ...
                          <div class="table-responsive p-0">
                              ...
                              <tbody >
                                  <?php //foreach($res_traslado['detalles'] as $f_detalle): ?>

                                      <tr class="">
                                      <th class="align-middle text-center text-xs"></th>
                                      <td class="text-xs"><input type="text" name="" id="txt_cod_producto"></td>
                      ...
                      <div class="card my-4">
                          ...
                          <div class="table-responsive p-0">
                              ...
                              <tbody class="data" id="data">
                                  <?php 
                                  if($res_traslado['detalles']):
                                    foreach($res_traslado['detalles'] as $f_detalle): 
                                  ?>
                                      ...
                                      <td class="pesokg text-center text-xs"><?php echo $f_detalle['pesokg']; ?></td>
 ...
 <script>
   $('#enviar_traslado').click(function () {
    ...
    var query_string="";
          ...
          +"&divSubtotal="+encodeURIComponent($("#divsubTotal > .number").text())
          +"&divTotal="+encodeURIComponent($("#divTotal > .number").text())
