...
$reg_facturas = getFacturas($filtro,$limite,$paginaI);
$reg_facturasPag = getfacturasPag($filtro);
$cliente_array = getClientsArray();
...
<!-- ===== -->
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
                            ...
                            <div class="container">
                              <div class="row">
                                <div class="col-6 d-flex align-items-center">
                                  <h6 class="mb-0 text-white text-capitalize ps-1">Facturas</h6>
                                </div>
                                <div class="col-sm-4 col-md-6 text-end">
                                  <a href="../../facturas/insert/" class="btn bg-gradient-info mb-0" href="javascript:;"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Agregar Factura</a>
                                </div>
                              </div>
                            </div>
                          </div>
                              ...
                              <table class="table align-items-center justify-content-center mb-0">
                                  <thead>
                                      <tr>
                                          ...
                                          <th class="text-left text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Cliente</th>
                                  ...
                                  <?php 
                                  if($reg_facturas ):
                                    foreach($reg_facturas as $r_factura): 
                                  ...
                                  ?>
                                      ...
                                      <tr>
                                          ...
                                          <td class="align-middle text-left text-xs"><?php echo array_search($r_factura['cliente_id'],$cliente_array); ?></td>
                                          ...
                                          <td class="text-center text-xs"><?php echo $r_factura['venta_id']; ?></td>
                                          <td class="text-center text-xs text-info"><?php echo "$ ".sprintf('%01.2f', $r_factura['total']); ?></td>
                                          <td class="text-center text-xs text-danger"><?php echo "$ ".sprintf('%01.2f', $r_factura['saldo']); ?></td>
                                          <td class="text-center text-xs">
                                            <?php if($r_factura['estado']=="VIGENTE") :?>
                                              <span class="badge badge-sm bg-gradient-success"><?php echo $r_factura['estado']; ?></span>
                                            <?php else:?>
                                              <span class="badge badge-sm bg-gradient-secondary"><?php echo $r_factura['estado']; ?></span>
                                            <?php endif; ?>
                                          </td>
                                          <td>
                                          <a href="../../facturas/view/?factura=<?php echo $r_factura['id']; ?>" style="font-size:.6rem;" type="button" class="btn btn-info btn-sm ml-2">ver</a>
                                          <a href="../../../resources/pdf/?factura=<?php echo $r_factura['id']; ?>" target="_blank" style="font-size:.6rem; background-color:#B20000; color:#ffffff;" type="button" class="btn btn-sm">PDF</a>
                                          ...
                                          <?php 
                                              ...
                                              $query="select * from sat_ce where sale='$r_factura[id]' limit 1";	
                                              $res=mysqli_query($conn,$query);
                                              if($res){

                                              $row_complement=mysqli_fetch_assoc($res);
                                              $complement_export=$row_complement['id'];
                                              //echo $complement_export;
                                          ...
                                          <?php if($xml_path) :?>
                                              ...
                                              <?php if($r_factura['timbrado']=="PENDIENTE") :?>
                                                    ...
                                                    <?php if($complement_export) :?>
                                                    <button id="get_xml" onclick='timbrar_ce(this)' style="font-size:.6rem;" type="button" class="btn btn-danger btn-sm">Timbrar</button>
                                                    <?php else:?>
                                                      <button id="get_xml" onclick='timbrar(this)' style="font-size:.6rem;" type="button" class="btn btn-danger btn-sm">Timbrar</button>
                                                    <?php endif; ?>
                                          ...
                                          <?php else:?>
                                                  ...
                                                  <?php if($complement_export) :?>
                                                  <button id="get_xml" onclick='timbrar_ce(this)' style="font-size:.6rem;" type="button" class="get_xml btn btn-warning btn-sm">generar</button>
                                                  <?php else:?>
                          ...
                          <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-center">
                              <li class="page-item <?php echo $_GET['pagina']<=1?'disabled':''; ?>">
                                <a class="page-link" href="<?php echo "http://" . $_SERVER['SERVER_NAME'] ."/facturacion"; ?>/views/facturas/search/?pagina=<?php echo $_GET['pagina']-1; ?>" aria-label="Previous">
                              ...
                              ?>
                              <li class="page-item <?php echo $_GET['pagina']==$i+1 ? "active":""; ?>"><a class="page-link" href="<?php echo "http://" . $_SERVER['SERVER_NAME'] ."/facturacion"; ?>/views/facturas/search/?pagina=<?php echo $i+1; ?>"><?php echo $i+1; ?></a></li>
                              <?php endfor; ?>
                              <span class="mx-2">...</span>

                              <?php if($_GET['pagina']>=$sig_pag): ?>
                              <li class="page-item  active"><a class="page-link" href="<?php echo "http://" . $_SERVER['SERVER_NAME'] ."/facturacion"; ?>/views/facturas/search/?pagina=<?php echo $i+1; ?>"><?php echo $_GET['pagina']; ?></a></li>
                              <?php endif; ?>
                              
                              <li class="page-item <?php echo $_GET['pagina']>=$paginas?'disabled':''; ?>">
                                <a class="page-link" href="<?php echo "http://" . $_SERVER['SERVER_NAME'] ."/facturacion"; ?>/views/facturas/search/?pagina=<?php echo $_GET['pagina']+1; ?>" aria-label="Next">
     ...
     <script>
        ...
        /* ========= Timbrar Comercio exterior ========== */


        function timbrar_ce(factura_id){
    ...
    $(document).ready(function () {
      ...
      //$('li.nav-item a').click(function(){
            ...
            $("#menu_factura").addClass("active");
            $("#menu_factura").addClass("bg-gradient-primary");
      // });
