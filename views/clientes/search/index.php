...
$limite=10;
$filtro="empty";
$reg_clients = getClients($filtro,$limite,$paginaI);

$reg_clientpag = getClientsPag($filtro);

$registros = count($reg_clientpag); 
//$cant_art= $registros;
$paginas=$registros/10;
$paginas=ceil($paginas);

//echo json_encode($reg_clients);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<!-- ===== -->
                            ...
                            <div class="container">
                              <div class="row">
                                <div class="col-6 d-flex align-items-center">
                                  <h6 class="mb-0 text-white text-capitalize ps-1">Clientes</h6>
                                </div>
                                <!-- <div class="col-sm-4 col-md-6 text-end">
                                  <a href="../../clientes/insert/" class="btn bg-gradient-info mb-0" href="javascript:;"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Agregar Cliente</a>
                                </div> -->
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="card-body px-0 pb-2">
                            <div class="table-responsive p-0">
                              <table id="table_res" class="table align-items-center justify-content-center mb-0">
                                  ...
                                  <tbody id="tbody_res">
                                  <?php foreach($reg_clients as $r_client): ?>

                                      <tr>
                                          <th class="align-middle text-center text-xs"><?php echo $r_client['id']; ?></th>
                                          <td class="align-middle text-left text-xs"><?php echo $r_client['cliente']; ?></td>
                                          <td class="align-middle text-center text-xs"><?php echo $r_client['rfc']; ?></td>
                                          <td class="align-middle text-center text-xs"><?php echo $r_client['codigo']; ?></td>
                                          <td class="text-center text-xs"><?php echo $r_client['precio']; ?></td>
                                          <td class="text-center text-xs"><?php echo $r_client['contacto']; ?></td>
                                          <td class="text-center text-xs"><?php echo $r_client['celular']; ?></td>
                                          <!-- <td>
                                          <a href="../../clientes/view/?cliente=<?php echo $r_client['id']; ?>" style="font-size:.6rem;" type="button" class="btn btn-info btn-sm ml-2">ver</a>
                          ...
                          <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-center">
                              <li class="page-item <?php echo $_GET['pagina']<=1?'disabled':''; ?>">
                                <a class="page-link" href="<?php echo "http://" . $_SERVER['SERVER_NAME'] ."/facturacion"; ?>/views/clientes/search/?pagina=<?php echo $_GET['pagina']-1; ?>" aria-label="Previous">
                              ...
                              ?>
                              <li class="page-item <?php echo $_GET['pagina']==$i+1 ? "active":""; ?>"><a class="page-link" href="<?php echo "http://" . $_SERVER['SERVER_NAME'] ."/facturacion"; ?>/views/clientes/search/?pagina=<?php echo $i+1; ?>"><?php echo $i+1; ?></a></li>
                              <?php endfor; ?>
                              <span class="mx-2">...</span>

                              <?php if($_GET['pagina']>=$sig_pag): ?>
                              <li class="page-item  active"><a class="page-link" href="<?php echo "http://" . $_SERVER['SERVER_NAME'] ."/facturacion"; ?>/views/clientes/search/?pagina=<?php echo $i+1; ?>"><?php echo $_GET['pagina']; ?></a></li>
                              <?php endif; ?>
                              
                              <li class="page-item <?php echo $_GET['pagina']>=$paginas?'disabled':''; ?>">
                                <a class="page-link" href="<?php echo "http://" . $_SERVER['SERVER_NAME'] ."/facturacion"; ?>/views/clientes/search/?pagina=<?php echo $_GET['pagina']+1; ?>" aria-label="Next">
    ...
    $(document).ready(function () {
      ...
      //$('li.nav-item a').click(function(){
            ...
            $("#menu_cliente").addClass("bg-gradient-primary");
      // });
