...
satxmlsv40_cce11($arr, $edidata, $dir, $nodo);
...
satxmlsv40_cargaAtt($root, array(
...
function satxmlsv40_cce11($arr, $edidata, $dir, $nodo)
{
    ...
    satxmlsv40_cargaAtt($cce11, array(
        "Version" => "1.1",
    ...
    if ($Cemisor == true) {
        ...
        satxmlsv40_cargaAtt($Cemisor, array(
            "Curp" => false
        ...
        if ($domicilioE == true) {
            ...
            satxmlsv40_cargaAtt($domicilioE, array(
                "Calle" => "Calle",
    ...
    if ($Cpropietario == true) {
        ...
        satxmlsv40_cargaAtt($Cpropietario, array(
            "NumRegIdTrib" => false,
    ...
    if ($Creceptor == true) {
        ...
        satxmlsv40_cargaAtt($Creceptor, array(
            "NuRegIdTrib" => false,
        ));
        ...
        satxmlsv40_cargaAtt($domicilioR, array(
            "Calle" => "Calle",
            "NumeroExterior" => "943",
            "Colonia" => false,
            "Localidad" => "Calexico",
    ...
    if ($Cmercancias == true) {
        ...
        satxmlsv40_cargaAtt($Cmercancia, array(
            "NoIdentificacion" => "003100140575",
            "FraccionArancelaria" => "0101210100",
            "CantidadAduana" => "1884.960",
            "UnidadAduana" => "07",
    ...
    if ($descripEspecificas == true) {
        ...
        satxmlsv40_cargaAtt($descripEspecificas, array(
            "Marca" => "23",
            "Modelo" => "555",
            "SubModelo" => "777",
            "NumeroSerie" => "8",
...
$todo = $xml->saveXML();
$nufa = "CE-".$arr['serie'].$arr['folio'];    // Junta el numero de factura   serie + folio
$paso = $todo;
