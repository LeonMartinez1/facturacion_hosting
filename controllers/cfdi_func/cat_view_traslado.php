...
$query = "SELECT * from sat_ce_colonia1 where c_codigo_postal ='$c_cod_p'
UNION
SELECT * from sat_ce_colonia2 where c_codigo_postal ='$c_cod_p'
UNION
SELECT * from sat_ce_colonia3 where c_codigo_postal ='$c_cod_p'
LIMIT 1";
$res=mysqli_query($conn,$query);
$json = [];
